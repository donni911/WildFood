<template>
  <div>
    ...
    <transition name="pop">
      <div class="m-modal" v-if="modal" appear>
            ...
            <div class="c-quiz">
              <transition mode="out-in">
                ...
                >
                  ...
                  >
                    <div
                      class="text-primary font-sans text-xs md:text-[24px]"
                    ></div>
                    <div
                      ...
                      <transition mode="out-in">
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <label
                                v-for="input in questions[activeQuestion]
                                  .variants"
                                :key="input.title"
                              ...
                              >
                                <input
                                  ...
                                  :type="
                                    input.title == 'months' ? 'number' : 'text'
                                  "
                  ...
                  <div class="flex flex-grow">
                    <div class="flex flex-col w-full">
                      ...
                      <p class="c-description text-lg">
                        Based on your answers, we have calculated a personal

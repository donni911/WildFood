        ...
        >
          <transition mode="out-in">
            ...
            >
              ...
              >
                <template v-if="questions[activeQuestion].type === 'mail'">
                ...
                <template v-else>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <template v-if="variant.icon && variant.icon == 'dog'">
                          <svg
                            width="24"
                            height="25"
                            viewBox="0 0 24 25"
                        ...
                        <template v-if="variant.icon && variant.icon == 'cat'">
                          <svg
                            width="24"
                            height="25"
                            viewBox="0 0 24 25"
            ...
            <div v-else class="flex flex-col w-full">
              ...
              <p class="c-description text-lg mb-5">
                Your promo code for a <b>35% discount:</b> <b>Wildfood35</b> The
                promo code will be applied automatically during checkout.
              </p>
              <p class="c-description text-lg mb-5">
                    ...
                    <a :href="item.url" class="c-product">
                      <div class="c-product__image">
                        <img
                          ...
                          :class="{ 'c-product__image--loading': loading[key] }"
                        />
                        <div v-if="loading[key]" class="c-product__loading">
                          <svg
                            width="158"
                            height="26"
                            viewBox="0 0 158 26"
